 ...
 */
class MyBbsBoardsFactory implements BbsBoardsFactory {
    ...
    /** */
    public List readFrom(String url) throws IOException {
        ...
        try {
            ...
            baos.flush();
            String boardListHtml = Cp932.toUnicode(baos.toByteArray());
